            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div
                        ...
                        data-kt-menu-placement="bottom-end">
                        @if(app()->getLocale() =='en')
                            <?php $image_lang=asset('assets/media/flags/united-states.svg')?>
                        @elseif(app()->getLocale() =='ar')
                            <?php $image_lang=asset('assets/media/flags/egypt.svg') ?>
                        @endif
                    ...
                    <div
                        ...
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <div class="menu-item px-3">
                                <a rel="alternate" hreflang="{{ $localeCode }}" class="menu-link d-flex px-5 "
                                   href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                    ...
                                    <span class="symbol symbol-20px me-4">
												<img class="rounded-1" src="{{$image_lang}}"
                                                     alt=""/>
											</span>
                                    {{ $properties['native'] }}
                                </a>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                         data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                         data-kt-menu-placement="bottom-end">
                        <img src="{{auth('admin')->user()->image}}" alt="user"/>
                    </div>
                    <!--begin::User account menu-->
                    <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{auth('admin')->user()->image}}"/>
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
