        ...
        <div id="kt_app_content_container" class="t_container" >
            <div class="card shadow-sm " style="border-top: 3px solid #007bff;">
                <div class="card-header">
                    <h3 class="card-title"></i> {{translate('add_task')}}</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12" style="margin-top: 10px">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descriptions" name="descriptions" rows="3" >{{ old('descriptions') }}</textarea>
                                <span style="color: red; font-size: 14px;" class="span_error_field_msg"></span>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-bordered"  id="mytable"  >
                                    ...
                                    @for ($y; $y <= 5; $y++)
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width: 230px;" type="date" name="date[]" class="form-control" id="date.{{ $y }}"
                                                       value=""/>
                                                <span style="color: red; font-size: 14px;" class="span_error_field_msg"></span>
                                            </td>
                                            <td>
                                                <input style="width: 230px;" type="time" name="time[]" class="form-control" id="time.{{ $y }}"
                                                       value=""/>
                                                <span style="color: red; font-size: 14px;" class="span_error_field_msg"></span>
                                            </td>
                                        </tr>
...
@section('js')
    ...
    <script>
        function save() {
            ...
            $.ajax({
                url: '{{route("admin.Tasks.save_task")}}',
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
