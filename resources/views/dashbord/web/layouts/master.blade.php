...
<head>
    ...
    @include('dashbord.web.layouts.head')
...
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
        <!--begin::Header-->
    @include('dashbord.web.layouts.main-headerbar')
    ...
    <!--end::Header-->
        ...
        <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
            ...
            <!--begin::Sidebar-->
        @include('dashbord.web.layouts.main-sidebar')
        ...
        <!--end::Sidebar-->
            ...
            <!--end::Content wrapper-->
                <!--begin::Footer-->
            @include('dashbord.web.layouts.footer')
...
@include('dashbord.web.layouts.footer-scripts')
