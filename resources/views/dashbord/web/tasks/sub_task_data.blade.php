@extends('dashbord.web.layouts.master')
@section('css')
            ...
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                <div class="card-header" style="background-color: #f8f9fa;">
                    ...
                    <div class="card-toolbar">
                        <div class="text-center">
                            <a class="btn btn-primary" href="{{ route('Tasks.tasks_data') }}">
                ...
                <div class="card-body" style="padding-left: 0px !important;">
                    <div class="col-md-12 row">
                                    ...
                                    <table id="table" class="example table table-bordered responsive nowrap text-center" cellspacing="0"
                                        ...
                                        @foreach ($sub_tasks as $task)
                                            ...
                                            <tr>
                                                ...
                                                $status='<a onclick="return confirm(\''.translate('change_type_msg').'\');" href="'.route('Tasks.update_status', [$task->id, $task->status,$tasks_data->id]).'" class="btn btn-'.$class_approved.' btn-sm">'.$icon_approved.' ' . $title_approved . '</a>';
                        ...
                        <div class="col-md-4">
                            @include('dashbord.web.tasks.task_details')
